 ...
 */
 ...
 /**
 * @typedef {object} fetchViewsParams
 ...
 * @param {{ params: fetchViewsParams | views }} req
 * @param {fetchViewsParams | views} req.params
 * @param {CbServer.Resp} resp
 */
function fetchViews(req, resp) {
  log(req)  
  ...
  if (cbQuery) {
    ...
    ["name", "icon", "width", "height"].forEach(function(name) {
